...
class Ribbon extends Basic {
	protected $SHORTCODE  = 'gt3pg_ribbon';
	...
	public function map(){
		...
		return array(
			'name'        => esc_html__('Ribbon', 'gt3pg_pro'),
			"category"    => esc_html__('GT3 Galleries', 'gt3pg_pro'),
			'description' => esc_html__('Ribbon Gallery', 'gt3pg_pro'),
			'base'        => $this->SHORTCODE,
			...
			'params'      => array(
				...
				/*array(
					"type"             => "textfield",
					"heading"          => esc_html__('Paddings around the images', 'gt3pg_pro'),
					"param_name"       => "itemsPadding",
					"group"            => esc_html__("Settings", 'gt3pg_pro'),
