...
if (!class_exists('ElementorModal\Widgets\GT3_Core_Elementor_Widget_Blog')) {
	class GT3_Core_Elementor_Widget_Blog extends \ElementorModal\Widgets\GT3_Core_Widget_Base {
		...
		public function get_name(){
			return 'gt3-core-blog';
		}

		public function get_title(){
			return esc_html__('Blog', 'gt3_themes_core');
		}

		public function get_icon(){
			return 'gt3-core-elementor-icon eicon-posts-masonry';
		}
