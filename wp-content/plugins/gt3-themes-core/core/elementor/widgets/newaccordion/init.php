...
if (!class_exists('ElementorModal\Widgets\GT3_Core_Elementor_Widget_NewAccordion')) {
	class GT3_Core_Elementor_Widget_NewAccordion extends \ElementorModal\Widgets\GT3_Core_Widget_Base {
