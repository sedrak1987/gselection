...
$widget->add_responsive_control(
    ...
    [
        ...
        'size_units' => [ 'px' ],
        'selectors' => [
            '{{WRAPPER}} .gt3-core-imagebox-img' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            '{{WRAPPER}} .gt3-core-imagebox-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ],
        'condition' => [
            'type' => 'image',
        ],
...
$widget->add_responsive_control(
    ...
    [
        ...
        'selectors' => [
            '{{WRAPPER}} .gt3-core-imagebox-wrapper .gt3-core-imagebox-img' => 'max-width: {{SIZE}}{{UNIT}};',
        ],
        'condition' => [
            'type' => 'image',
        ],
...
$this->add_responsive_control(
    ...
    [
        ...
        'selectors' => [
            '{{WRAPPER}} .gt3-core-imagebox-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            '{{WRAPPER}} .gt3-core-imagebox-title > .elementor-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ],
        'condition' => [
	        'view!' => 'default',
        ],
