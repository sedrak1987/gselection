...
$widget->add_control(
	...
	array(
		...
		'default'     => '1px',
		'selectors'   => array(
			'{{WRAPPER}}.elementor-widget-gt3-core-button .gt3_module_button_elementor a'                                                                     => 'border-width: {{VALUE}};',
			'{{WRAPPER}}.elementor-widget-gt3-core-button .gt3_module_button_elementor a.hover_type2 .gt3_module_button__container .gt3_module_button__cover' => 'border-width: {{VALUE}};',
		),
		'condition'   => array(
			'btn_border_style!' => 'none',
		),
