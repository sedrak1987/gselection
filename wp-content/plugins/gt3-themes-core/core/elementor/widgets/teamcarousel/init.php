...
if ( ! class_exists( 'ElementorModal\Widgets\GT3_Core_Elementor_Widget_TeamCarousel' ) ) {
	class GT3_Core_Elementor_Widget_TeamCarousel extends \ElementorModal\Widgets\GT3_Core_Widget_Base {

		public function get_name() {
			return 'gt3-core-teamcarousel';
		}

		public function get_title() {
			return esc_html__( 'Team Carousel', 'gt3_themes_core' );
		}
