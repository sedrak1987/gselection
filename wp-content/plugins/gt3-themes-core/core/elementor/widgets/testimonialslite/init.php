...
if (!class_exists('ElementorModal\Widgets\GT3_Core_Elementor_Widget_TestimonialsLite')) {
	class GT3_Core_Elementor_Widget_TestimonialsLite extends \ElementorModal\Widgets\GT3_Core_Widget_Base {
		...
		public function get_name(){
			return 'gt3-core-TestimonialsLite';
		}
