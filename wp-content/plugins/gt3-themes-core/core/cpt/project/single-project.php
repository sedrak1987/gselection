	...
	if ( !post_password_required() ) {
				...
				<div class="content-container span<?php echo (int)$column; ?>">
					<section id='main_content'>
						<?php
							...
							wp_link_pages(array('before' => '<div class="page-link">' . esc_html__('Pages', 'qudos') . ': ', 'after' => '</div>'));
		...
		<div class="single_prev_next_posts">
			<div class="container">
				...
				if (!empty($prev_post)) {
					previous_post_link('<div class="fleft">%link</div>', '<span class="big_arrow_prev"><i class="fa fa-angle-left"></i></span><span class="gt3_mobile_visible">' . esc_html__('Prev', 'qudos') . '</span><span class="gt3_mobile_hidden">' . esc_html__('Previous Project', 'qudos') . '</span>');
				}
				...
				if (!empty($next_post)) {
					next_post_link('<div class="fright">%link</div>', '<span class="gt3_mobile_visible">' . esc_html__('Next', 'qudos') . '</span><span class="gt3_mobile_hidden">' . esc_html__('Next Project', 'qudos') . '</span>' . '<span class="big_arrow_next"><i class="fa fa-angle-right"></i></span>');
				}
				?>
			</div>
		</div>
