...
(function( $ ) {
    ...
    redux.field_objects.wpd_custom_font = redux.field_objects.wpd_custom_font || {};

    $( document ).ready(
        function() {
            redux.field_objects.wpd_custom_font.init();
        }
    );

    redux.field_objects.wpd_custom_font.init = function( selector ) {
